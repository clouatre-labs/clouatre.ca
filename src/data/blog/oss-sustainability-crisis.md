...
Your CI pipeline trusts 400 packages. Last week, one of them laid off 75% of its engineering team. Ten months ago, another nearly shipped a backdoor to every major Linux distribution. Last month, attackers started registering package names that only exist because an AI hallucinated them.
